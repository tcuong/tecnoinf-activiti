...
public class GuardarMinutaComCarrera implements JavaDelegate {
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		String resolucion = execution.getVariable("resolucionCC").toString();
		String nombreFuncionario = execution.getVariable("nombreFuncionarioCC")
				.toString();
		String nombreEntidad = execution.getVariable("nombreEntidadCC")
				.toString();

		boolean aprobado = (boolean) execution.getVariable("aprobadaCC");
		...
		String solicitud = execution.getVariable("solicitudCC").toString();
